...
var ObsRouter = function(opts){
	...
	if (self._bindToWindow){
		History.Adapter.bind(window, 'statechange', function(){
			self._update(document.location.pathname + document.location.search, true);
		});
...
//ObsRouter.prototype.destroy = function(){var self = this; ObsRouterBase.prototype.destroy.call(self);};
delete ObsRouter.prototype.destroy;
