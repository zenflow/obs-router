...
ObsRouter.prototype.setRoute = function(route, params, extend_params){
	this._update(this.toUrl(route, params, extend_params), true);
};
ObsRouter.prototype.pushRoute = function(route, params, extend_params){
	var self = this;
	self.pushUrl(self.toUrl(route, params, extend_params));
};
...
ObsRouter.prototype.toUrl = function(route, params, extend_params){
	var self = this;
